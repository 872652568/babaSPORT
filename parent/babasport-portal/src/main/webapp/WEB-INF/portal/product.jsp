...
<body>
	...
	<div class="w">
		<div class="breadcrumb">
			<strong> <a href="javascript:;">运动户外</a>
			</strong> <span>&nbsp;&gt;&nbsp; <a href="javascript:;">健身训练</a>&nbsp;&gt;&nbsp;
			...
			<span><a href="javascript:;">依琦莲</a>&nbsp;&gt;&nbsp;<a
				href="javascript:;">${product.name }</a> </span>
		</div>
	</div>
	<!--breadcrumb end-->
	<div class="w">
						...
						<div class="dd" id="colors">
							<c:forEach items="${colors }" var="color">
								<div class="item" onclick="colorToRed(this,'${color.id}')">
									<b></b> <a href="javascript:;" title="${color.name }"> <img
										data-img="1" src="/images/53f44cc2N0b714cb2_002.jpg"
				...
				<div id="preview">
					...
					<div id="short-share">
						<div id="view-bigimg" class="fl">
							<b></b><a href="/images/example1.jpg" target="_blank">查看大图</a>
						</div>
						<div id="share-list" class="share-list"
							...
							<div class="share-bd">
								...
								<ul class="share-list-item clearfix">
									...
									<li><a href="javascript:;" id="site-kaixing"
										title="分享到开心网">开心网</a></li>
				...
				<div id="product-detail" class="m m1" data-widget="tabs"
					...
					<div class="mc" data-widget="tab-content" id="product-detail-1">
						<ul class="detail-list">
							...
							<li title="淘梦服饰专营店">店铺： <a
								href="http://mall.jd.com/index-110420.html" target="_blank">淘梦服饰专营店</a></li>
					...
					<div id="product-detail-6" class="mc hide"
						data-widget="tab-content"></div>
					<!--知识库二级标签、标题-->
					<div id="promises">
				...
				<div class="mc">
					<ul>
						<li data-push="1" class="fore1">
							<div class="p-img">
								<a href="//item.jd.com/1409519600.html" title="" target="_blank">
									<img width="160" height="160" data-lazy-img="done" alt=""
									src="//img10.360buyimg.com/n2/jfs/t1546/262/352310690/199216/a1b1ed81/55779165Nb9a1d958.jpg"
									class="">
								</a>
							</div>
							<div class="p-name">
								<a href="//item.jd.com/1409519600.html" title="" target="_blank">
									皮尔瑜伽pieryoga 秋冬舞蹈家居瑜伽服女套装胸垫41343 短橘桃+41868橘桃 M </a>
							</div>
							<div class="p-price">
						...
						<li data-push="2" class="fore2">
							<div class="p-img">
								<a href="//item.jd.com/1635706164.html" target="_blank"> <img
									width="160" height="160" data-lazy-img="done" alt=""
									src="//img14.360buyimg.com/n2/jfs/t1441/191/717818107/191061/52fde152/55a4e8a6Nd90a8abb.jpg"
									class=""></a>
							</div>
							<div class="p-name">
								<a href="//item.jd.com/1635706164.html" title="" target="_blank">
									皮尔瑜伽pieryoga 2015春夏舞蹈家居瑜伽服女套装胸垫53406M 柔和蓝+水墨兰 M </a>
							</div>
							<div class="p-price">
