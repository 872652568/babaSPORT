				...
				<tbody>
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required" name="name" maxlength="100" /></td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h"><span
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required" name="description" maxlength="80" size="60" /></td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h">排序:</td>
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required" name="sort" maxlength="80" /></td>
					</tr>
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="radio"
							...
							type="radio" name="isDisplay" value="0" />不可用</td>
					</tr>
				</tbody>
				<tbody>
					<tr>
