...
.topbg {
	background: url(/images/admin/top-tbg.png) no-repeat;
	height: 38px;
}
...
.login-welcome {
	...
	color: #fff;
	font-size: 12px;
	background: url(/images/admin/topbg.gif) no-repeat;
}
...
.nav .current {
	background: url(/images/admin/navcurrbg.gif) no-repeat 0px 2px;
	color: #fff;
	width: 72px;
	text-align: center;
}
...
.nav-menu li.sep {
	background: url(/images/admin/step.png) no-repeat;
	width: 2px;
	height: 31px;
	margin: 0px 5px;
}
...
.top-bottom {
	width: 100%;
	background: url(/images/admin/bg.png) repeat-x 0px -34px;
	height: 3px;
}
						...
						<div class="topbg">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="420" height="38"><img
											src="/images/admin/welconlogin-icon.png" /><span id="welcome">您好:admin!</span>
											<img src="/images/admin/loginout-icon.png" /><a
											href="logout.do?returnUrl=index.do" target="_top" id="logout"
											onclick="return confirm('您确定退出吗?');">退出</a>  <img
											src="/images/admin/message-unread.png" />&nbsp;<a
											href="message/v_list.do" target="rightFrame">你有<span
												id="countDiv">0</span>条信息未读
										</a></td>
									</tr>
								</table>
							</div>
							<div class="nav">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td
											style="background-image: url('/images/admin/nav-left.png')"
											width="14" height="31"></td>
										<td>
											<ul class="nav-menu">
												<li class="current" id="tb_11" onclick="HoverLi(11);"><a
													href="main.jsp" target="mainFrame">首页</a></li>
												<li class="sep"></li>
												<li class="normal" id="tb_12" onclick="HoverLi(12);"><a
													href="/frame/product_main.do" target="mainFrame">商品</a></li>
												<li class="sep"></li>
												<li class="normal" id="tb_13" onclick="HoverLi(13);"><a
													href="/frame/order_main.do" target="mainFrame">订单</a></li>
												<li class="sep"></li>
												<li class="normal" id="tb_14" onclick="HoverLi(14);"><a
													href="frame/ad_main.jsp" target="mainFrame">广告</a></li>
												<li class="sep"></li>
												...
												<li class="sep"></li>
												<li class="normal" id="tb_21" onclick="HoverLi(21);"><a
