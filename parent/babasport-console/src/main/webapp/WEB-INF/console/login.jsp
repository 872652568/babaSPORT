...
body {
	...
	padding: 0;
	font-size: 12px;
	background: url(${base}/res/jeecms/img/login/bg.jpg) top repeat-x;
}
...
<body>
	<form id="jvForm" action="login.do" method="post">
		<#if returnUrl??><input type="hidden" name="returnUrl"
			value="${returnUrl}" /></#if> <#if processUrl??><input type="hidden"
			name="processUrl" value="${processUrl}" /></#if>
				...
				<td><table width="100%" border="0" cellspacing="0"
						...
						<tr>
							...
							<td width="40" align="center" valign="bottom"><img
								src="${base}/res/jeecms/img/login/line.jpg" width="23"
								height="232" /></td>
							<td valign="top"><table width="100%" border="0"
									cellspacing="0" cellpadding="0">
									<tr>
										<td height="90" align="center" valign="bottom"><img
											src="${base}/res/jeecms/img/login/ltitle.jpg" /></td>
									</tr>
									<tr>
										<td>
											<div>
											...
											<table width="100%" border="0" align="center" cellpadding="0"
												...
												<tr>
													<td width="91" height="40" align="right"><strong>
															<@s.m "login.username"/>ï¼</strong></td>
													<td width="211"><input type="input" id="username"
														name="username" vld="{required:true}" maxlength="100"
														class="input" /></td>
												</tr>
												<tr>
													...
													<td><input name="password" type="password"
														id="password" maxlength="32" vld="{required:true}"
														class="input" /></td>
												</tr>
												...
												<tr>
													<td colspan="2" align="center"><img
														...
														onclick="this.src='${base}/captcha.svl?d='+new Date()*1" /></td>
												</tr>
												<tr>
													<td height="40" align="right"><strong><@s.m
												...
												<tr>
													<td height="40" colspan="2" align="center"><input
														type="image" src="${base}/res/jeecms/img/login/login.jpg"
														name="submit" /> &nbsp; &nbsp; <img name="reg"
														style="cursor: pointer"
														src="${base}/res/jeecms/img/login/reset.jpg"
